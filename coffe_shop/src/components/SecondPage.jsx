	...
	return (
		<>
			<div id='about' className={css.secondpage}>
				<img className={`${css.coffe} icon`} src={coffe} alt='Coffee Icon' />
				<img className={`${css.coffePot} icon`} src={coffePot} alt='Coffee Pot Icon' />
				<img className={`${css.coffeBean} icon`} src={coffeBean} alt='Coffee Bean Icon' />
				<img className={`${css.coffeBean2} icon`} src={coffeBean} alt='Coffee Bean Icon' />
				<img className={`${css.coffeBean3} icon`} src={coffeBean} alt='Coffee Bean Icon' />
				...
				<div className={css.secondpageContents}>
					...
					<div className={css.splitdivp}>
						...
						<p className={css.p}>
							...
							consequatur cum debitis dolor incidunt ipsum iure molestiae odio quae,
							ratione saepe sequi, suscipit temporibus vitae? Blanditiis nam neque
							nihil.
						</p>
					</div>
				</div>
