    ...
    return (
        <>
            <div className={css.header}>
                <div className={`${css.navBar} ${isHamburgerVisible ? css.show : ''}`}>
                ...
                <div id='hamburger' className={`${css.hamburger} ${isHamburgerVisible ? '' : css.show}`}>
                    <a href='#home' id='navItem' className={css.navbarItem} onClick={handleHamburgerButtonClick}>
                        <h2 className={css.navbarText}>Home</h2>
                    </a>
                    <a href='#about' id='navItem' className={css.navbarItem} onClick={handleHamburgerButtonClick}>
                        <h2 className={css.navbarText}>About</h2>
                    </a>
                    <a href='#menu' id='navItem' className={css.navbarItem} onClick={handleHamburgerButtonClick}>
                        <h2 className={css.navbarText}>Menu</h2>
                    </a>
                    <a href='#blog' id='navItem' className={css.navbarItem} onClick={handleHamburgerButtonClick}>
                        <h2 className={css.navbarText}>Blog</h2>
                    </a>
                    <a href='#shop' id='navItem' className={css.navbarItem} onClick={handleHamburgerButtonClick}>
                        <h2 className={css.navbarText}>Shop</h2>
                    </a>
                    <a href='#contact' id='navItem' className={css.navbarItem} onClick={handleHamburgerButtonClick}>
                        <h2 className={css.navbarText}>Contact</h2>
                    </a>
                </div>
